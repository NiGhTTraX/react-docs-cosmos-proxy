...
/******/ 	}
/******/ 	var parentHotUpdateCallback = this["webpackHotUpdatereact_cosmos_docs_proxy"];
/******/ 	this["webpackHotUpdatereact_cosmos_docs_proxy"] = 
...
// module
exports.push([module.i, ".docs-table {\n  padding: 4px;\n}\n.docs-table header .title {\n  font-size: 24px;\n}\n.docs-table header .description {\n  font-size: 18px;\n  margin-top: 16px;\n}\n.docs-table .props {\n  margin-top: 20px;\n}\n.docs-table .props .prop-header {\n  padding: 4px 8px;\n  font-weight: bold;\n  border-bottom: 1px solid #0b273b;\n}\n.docs-table .props .prop td {\n  padding: 4px 8px;\n}\n.docs-table .props .prop .name {\n  font-weight: 800;\n}\n", ""]);
...
// module
exports.push([module.i, ".header .content.hidden {\n  height: 0;\n  overflow: hidden;\n}\n.header .toggle {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  border: 0;\n  padding: 0;\n  background: #0c283d;\n}\n.header .toggle svg {\n  width: 20px;\n  height: 20px;\n  color: white;\n}\n", ""]);
...
var _react3 = __webpack_require__(20);

var _docsTable = __webpack_require__(24);
...
var headerCache = new _localstorage2.default('docs_proxy_header');
 ...
 */
var createDocsProxy = function createDocsProxy() {
  var _class, _temp;

  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$Docs = _ref.Docs,
      Docs = _ref$Docs === undefined ? DefaultDocsTable : _ref$Docs,
      _ref$docsProperty = _ref.docsProperty,
      docsProperty = _ref$docsProperty === undefined ? '__docgenInfo' : _ref$docsProperty;

  return _temp = _class = function (_Component) {
    _inherits(DocsProxy, _Component);

    function DocsProxy() {
      _classCallCheck(this, DocsProxy);

      return _possibleConstructorReturn(this, (DocsProxy.__proto__ || Object.getPrototypeOf(DocsProxy)).apply(this, arguments));
    }

    _createClass(DocsProxy, [{
      key: 'render',
      ...
      value: function renderDocs() {
        ...
        var docs = this.props.fixture.component[docsProperty];
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            _header2.default,
            { cache: headerCache },
            _react2.default.createElement(Docs, docs)
          )
        );
      }
    }]);
    ...
    return DocsProxy;
  }(_react.Component), _class.propTypes = _react3.proxyPropTypes, _temp;
};

exports.default = createDocsProxy;
...
var m=__webpack_require__(6),n=__webpack_require__(13),p=__webpack_require__(3),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
var _proxyPropTypes = __webpack_require__(21);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            Columns.map(function (_ref) {
              ...
              return _react2.default.createElement(
                'th',
                { key: header, className: 'prop-header' },
                header
              );
            })
          )
        ...
        _react2.default.createElement(
          ...
          Object.keys(props).map(function (prop) {
            return _react2.default.createElement(
              'tr',
              { key: prop, className: 'prop' },
              Columns.map(function (_ref2) {
                var header = _ref2.header,
                    PropInfo = _ref2.component;
                return _react2.default.createElement(
                  'td',
                  { key: header,
                    className: 'prop-info'
                  },
                  _react2.default.createElement(PropInfo, { name: prop, docs: props[prop] })
                );
              })
            );
          })
...
Docs.propTypes = {
   ...
   */
  props: _propTypes2.default.objectOf(_propTypes2.default.shape({
  ...
  _createClass(Default, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'span',
        null,
        required ? 'Required' : defaultValue && defaultValue.value
      );
    }
  }]);
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: (0, _classnames2.default)('content', { hidden: hidden }) },
          children
        ),
        _react2.default.createElement(
          'button',
    ...
    value: function renderToggle() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('path', { d: path, fill: 'currentColor' })
      );
    }
  }]);
...
Header.propTypes = {
  ...
  cache: _propTypes2.default.shape({
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onToggle = function () {
    var cache = _this2.props.cache;


    _this2.setState({ hidden: !_this2.state.hidden }, function () {
      cache.set('hidden', _this2.state.hidden);
    });
  };
};
...
var LocalStorage = function (_AbstractCache) {
  _inherits(LocalStorage, _AbstractCache);

  function LocalStorage(namespace) {
    _classCallCheck(this, LocalStorage);

    var _this = _possibleConstructorReturn(this, (LocalStorage.__proto__ || Object.getPrototypeOf(LocalStorage)).call(this, namespace));

    _this.store = _store2.default.namespace(namespace);
    return _this;
  }
...
var AbstractCache = function () {
   ...
   */
  function AbstractCache(namespace) {
  ...
  _createClass(AbstractCache, [{
    ...
    value: function get(key) {
      var value = this._get(this._getNamespacedKey(key));
    ...
    key: "_getNamespacedKey",
    value: function _getNamespacedKey(key) {
